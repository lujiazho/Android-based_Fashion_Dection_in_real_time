...
def class_text_to_int(row_label):
    array = ['coat', 'dress', 'shoe', 'T-shirt', 'skirt', 'stocking', 'bag',
             'belt', 'blouse', 'pants', 'scarf', 'sweater', 'hat', 'blazer',
             'jeans', 'sunglass', 'shorts', 'socks', 'legging']
    dictionary = {}
    for idx,clothes in enumerate(array):
        dictionary[clothes] = idx+1
